    ...
    configure({
      generateMessage: (ctx) => {
        const messages = {
          ...
          alpha_spaces: `The field ${ctx.field} is  may only contain alphanetic characters and spaces. `,
          email: `The field ${ctx.field} must be a valid email. `,
          min_value: `The field ${ctx.field} is too low. `,
          max_value: `The field ${ctx.field} is too high. `,
          excluded: `You are not allowd to use this value for the field ${ctx.field} . `,
          country_excluded: `Due to restrections, we do not accept users from this location. `,
